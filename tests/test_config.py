...
def test_alert_runtime_defaults_applied(monkeypatch: pytest.MonkeyPatch) -> None:
    set_required_env(monkeypatch)
...
def test_alert_severity_threshold_rejects_unknown(monkeypatch: pytest.MonkeyPatch) -> None:
    set_required_env(monkeypatch)
...
def test_alert_throttle_per_hour_must_be_positive(monkeypatch: pytest.MonkeyPatch) -> None:
    set_required_env(monkeypatch)
